...
const TopRated = () => {
  ...
  const { allTopRated, loadingInitial, loadingMore, handleLoadMore } =
    useTopRatedMovies();
  ...
  const TopRatedCard = ({ movie }) => {
    ...
    return (
      <div
        ...
        className="bg-white rounded-xl shadow-md overflow-hidden relative transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 cursor-pointer"
      >
